...
class VuexyWizard extends React.Component {
  ...
  handleSubmit = forms => {
    if (
      ...
      this.props.onFinish(forms)
    }else{
      if(this.state.errors.length) return 
      this.props.onNext&&this.props.onNext(this.state.activeStep, forms)
    }
  }
                ...
                <FormTag
                  ...
                  {this.props.pagination ? (
                    <div className="wizard-actions d-flex justify-content-between">
                      ...
                      <Button type="submit" color="primary" disabled={this.props.disableNextButton}>
